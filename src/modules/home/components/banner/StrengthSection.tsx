...
const StrengthSection = () => {
  return (
    <section className="w-full py-16">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-3 gap-12 text-tres-primary text-center">
        {/* Strong */}
        <div className="flex flex-col items-center">
          <BicepsFlexed strokeWidth={1.5} size={48} />
          <Heading level="h3" className="text-lg font-semibold mt-4 font-urw">
            STRONG
          </Heading>
          <Text className="font-urwCond">
        ...
        {/* Solid */}
        <div className="flex flex-col items-center">
          <Dumbbell strokeWidth={1.5} size={48} />
          <Heading level="h3" className="text-lg font-semibold mt-4 font-urw">
            SOLID
          </Heading>
          <Text className=" font-urwCond">
